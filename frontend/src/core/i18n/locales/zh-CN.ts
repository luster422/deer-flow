...
export const zhCN: Translations = {
  ...
  knowledgeBases: {
    title: "知识库",
    subtitle: "管理可供智能体检索的长期文档资料。",
    create: "创建知识库",
    createTitle: "创建知识库",
    createDescription: "将相关文档整理到同一个可检索来源中。",
    namePlaceholder: "名称",
    descriptionPlaceholder: "描述（可选）",
    emptyTitle: "暂无知识库",
    emptyDescription: "创建知识库后即可上传并索引参考文档。",
    summary: (documents, chunks) => `${documents} 个文档 · ${chunks} 个片段`,
    upload: "上传文档",
    document: "文档",
    size: "大小",
    chunks: "片段",
    ...
    retry: "重试入库",
    searchTitle: "检索预览",
    searchPlaceholder: "搜索已索引的文档片段",
    noResults: "没有找到相关片段",
    deleteTitle: "删除知识库？",
    deleteDescription: "文档、派生内容和索引数据将异步删除。",
    selectorLabel: "知识库",
    selectorEmpty: "暂无可用知识库",
    selectorManage: "管理知识库",
    status: {
      active: "可用",
      queued: "排队中",
      parsing: "解析中",
  ...
  toolCalls: {
    ...
    searchKnowledgeFor: (query: string) => `在知识库中检索 “${query}”`,
    viewWebPage: "查看网页",
    listFolder: "列出文件夹",
    readFile: "读取文件",
    writeFile: "写入文件",
