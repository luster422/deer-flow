...
export const enUS: Translations = {
  ...
  knowledgeBases: {
    ...
    subtitle: "Manage durable document sources available to your agents.",
    create: "Create knowledge base",
    createTitle: "Create knowledge base",
    createDescription: "Group related documents into a searchable source.",
    namePlaceholder: "Name",
    descriptionPlaceholder: "Description (optional)",
    emptyTitle: "No knowledge bases",
    emptyDescription: "Create one to upload and index reference documents.",
    summary: (documents, chunks) => `${documents} documents · ${chunks} chunks`,
    ...
    searchTitle: "Retrieval preview",
    searchPlaceholder: "Search indexed passages",
    noResults: "No relevant passages found",
    deleteTitle: "Delete knowledge base?",
    deleteDescription:
      "Documents, derived content, and index entries will be removed asynchronously.",
    selectorLabel: "Knowledge",
    selectorEmpty: "No knowledge bases available",
    selectorManage: "Manage knowledge bases",
    status: {
      active: "Active",
      queued: "Queued",
      parsing: "Parsing",
  ...
  toolCalls: {
    ...
    searchKnowledgeFor: (query: string) => `Search knowledge for "${query}"`,
